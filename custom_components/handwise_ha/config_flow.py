"""Config flow for Handwise MGC01."""
...
from .api import HandwiseCloudApiClient, HandwiseGenieApiError
from .const import (
    CONF_API_HOST,
    CONF_AREA_CODE,
    CONF_PASSWORD,
...
class HandwiseGenieConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle config flow for Handwise MGC01."""
    ...
    async def async_step_user(self, user_input: dict | None = None) -> FlowResult:
        ...
        if user_input is not None:
            ...
            cloud_client = HandwiseCloudApiClient(
                session=session,
